...
namespace DTT.UI.ProceduralUI.Editor
{
    ...
    /// </summary>
    public class HitboxSettingsSection : Section
    {
        ...
        private class HitboxSettingsContent : GUIContentCache
        {
            ...
            {
                Add(nameof(HitboxEnabledOption), () => new GUIContent("Enable Hitbox Detection", "Do you want to be able to 'hit' " +
                ...
                Add(nameof(OutsideHitBoxDetection), () => new GUIContent("Outer Hitbox Detection"));
                ...
                Add(nameof(InsideHitBoxDetection), () => new GUIContent("Inner Hitbox Detection"));
