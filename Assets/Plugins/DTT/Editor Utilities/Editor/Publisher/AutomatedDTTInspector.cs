...
{
    /// <summary>
    /// Provides functionalities to automate your publisher inspector. All basis custom editor 
    /// functionalities can be initialized by override the <see cref="OnEnable"/> and using the
