...
{
    /// <summary>
    /// The read me scriptable object asset which is shown to the  
    /// user when he imports this package for this first time.
    /// </summary>
    [System.Serializable]
    public class DTTReadMe
    {
        #region Variables
        #region Public
        /// <summary>
        ...
        /// </summary>
        public List<ReadMeSection> loadedSections = new List<ReadMeSection>();
        ...
        /// by updating the sections folder and reloading the sections.
        /// </summary>
