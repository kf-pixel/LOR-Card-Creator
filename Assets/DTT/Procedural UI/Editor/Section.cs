...
namespace DTT.UI.ProceduralUI.Editor
{
    ...
    public abstract class Section : IDrawable
    {
        ...
        /// </summary>
        protected RoundedImage _roundedImage;
        #endregion
        ...
        /// </param>
        public Section(RoundedImage roundedImage, UnityAction repaint)
        {
        ...
        protected float DrawSlider(RoundingUnit unit, float currentValue, GUIContent content)
        {
            switch (unit)
            {
                ...
                case RoundingUnit.WORLD:
                    float maxValue = _roundedImage.rectTransform.rect.GetShortLength() / 2;
