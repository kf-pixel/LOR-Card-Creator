...
public class CardTypeChanger : MonoBehaviour
{
	...
	[SerializeField] private TMP_InputField inputManaField;
	private int prior_i;
	...
	public void ParseType()
	{
		...
		// Blank out Skill Mana Cost
		if ((CardTypes)i == CardTypes.Skill)
		{
			inputManaField.text = "";
		}
		else
		{
			if (string.IsNullOrEmpty(inputManaField.text))
			{
				inputManaField.text = "1";
			}
		}
