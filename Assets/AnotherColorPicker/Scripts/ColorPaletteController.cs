...
public class ColorPaletteController : MonoBehaviour, IBeginDragHandler, IDragHandler,IEndDragHandler, IInitializePotentialDragHandler, IPointerDownHandler
{
	...
	public void ClickToSelect(Vector3 position)
	{
